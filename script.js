document.addEventListener('DOMContentLoaded', function() {
    ...
    const translations = {
        ru: {
            ...
            card1_text1: "Стримить буду разные игры на прекрасной платформе Twitch Не хайпуюсь, а стримлю чисто для себя не гонясь за популярностью.",
            ...
            card3_note: "Всё что тянет в то и играю, мне плевать насколько игра популярна не популярна. В что и играю то и играю.",
        ...
        en: {
            ...
            card3_note: "I play whatever draws me to it, I don't care how popular it is. I play whatever I want.",
